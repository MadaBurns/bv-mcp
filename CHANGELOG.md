...
Scoring model 1.29.0, `@blackveil/dns-checks` 1.41.0 (`PARITY_CORPUS_VERSION` in lockstep) — bv-web-prod re-vendor required. No category weights, grade bands or severity penalties change.
