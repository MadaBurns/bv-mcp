...
Scoring model 1.26.0, `@blackveil/dns-checks` 1.38.0 (`PARITY_CORPUS_VERSION` in lockstep) — bv-web-prod re-vendor required. No category weights, grade bands or severity penalties change.
