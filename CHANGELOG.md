...
Scoring model 1.27.0, `@blackveil/dns-checks` 1.39.0 (`PARITY_CORPUS_VERSION` in lockstep) — bv-web-prod re-vendor required. No category weights, grade bands or severity penalties change.
