...
// also present BV_MCP_OAUTH_MINT_KEY, mirroring /oauth/grants. Success-path
...
const TEST_INTERNAL_KEY = 'trial-mint-capability-test-key-32-bytes';

type TestEnv = typeof env & { BV_MCP_OAUTH_MINT_KEY?: string };
...
describe('/internal/trial-keys auth gate', () => {
	it('returns 503 when BV_MCP_OAUTH_MINT_KEY is not configured (POST /trial-keys)', async () => {
