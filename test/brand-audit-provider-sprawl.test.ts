...
describe('groupByProvider', () => {
	...
	it('returns multiple providers when NS list crosses orgs', () => {
		expect(
			groupByProvider(['a.ns.[redacted-domain]', 'b.ns.[redacted-domain]', 'pdns1.ultradns.net', 'pdns2.ultradns.com']),
...
describe('isMultiProvider', () => {
	...
	it('returns true for paypal-style UltraDNS + in-house', () => {
		expect(
			isMultiProvider(['pdns1.ultradns.net', 'pdns2.ultradns.com', 'a.ns.[redacted-domain]', 'b.ns.[redacted-domain]']),
		).toBe(true);
	});
