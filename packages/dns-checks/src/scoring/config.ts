...
export const DEFAULT_SCORING_CONFIG: ScoringConfig = {
	...
	profileWeights: {
		mail_enabled: { dmarc: 16, dkim: 10, spf: 10, ssl: 8, subdomain_takeover: 3, dnssec: 8, mta_sts: 2, mx: 2, tlsrpt: 1, caa: 0, ns: 0, bimi: 0, lookalikes: 0, shadow_domains: 0, txt_hygiene: 0, http_security: 5, dane: 1, mx_reputation: 0, srv: 0, zone_hygiene: 0, dane_https: 2, svcb_https: 1 },
		enterprise_mail: { dmarc: 18, dkim: 12, spf: 12, ssl: 8, subdomain_takeover: 3, dnssec: 8, mta_sts: 4, mx: 2, tlsrpt: 2, caa: 0, ns: 0, bimi: 1, lookalikes: 0, shadow_domains: 0, txt_hygiene: 0, http_security: 5, dane: 2, mx_reputation: 0, srv: 0, zone_hygiene: 0, dane_https: 2, svcb_https: 1 },
		non_mail: { ssl: 8, subdomain_takeover: 5, dnssec: 8, caa: 3, dmarc: 1, ns: 2, dkim: 1, spf: 1, mx: 0, mta_sts: 0, tlsrpt: 0, bimi: 0, lookalikes: 0, shadow_domains: 0, txt_hygiene: 0, http_security: 5, dane: 0, mx_reputation: 0, srv: 0, zone_hygiene: 0, dane_https: 2, svcb_https: 1 },
		web_only: { ssl: 12, subdomain_takeover: 5, dnssec: 8, caa: 5, dmarc: 0, ns: 2, dkim: 0, spf: 0, mx: 0, mta_sts: 0, tlsrpt: 0, bimi: 0, lookalikes: 0, shadow_domains: 0, txt_hygiene: 0, http_security: 5, dane: 0, mx_reputation: 0, srv: 0, zone_hygiene: 0, dane_https: 2, svcb_https: 1 },
		minimal: { dmarc: 3, ssl: 6, dnssec: 6, dkim: 2, spf: 3, subdomain_takeover: 3, ns: 2, mx: 1, caa: 1, mta_sts: 0, tlsrpt: 0, bimi: 0, lookalikes: 0, shadow_domains: 0, txt_hygiene: 0, http_security: 2, dane: 0, mx_reputation: 0, srv: 0, zone_hygiene: 0, dane_https: 0, svcb_https: 0 },
	},
