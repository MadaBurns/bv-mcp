...
pub fn required_mode_for_tool(tool: &str) -> PermissionMode {
    match tool {
        ...
        "batch_scan_findings" => PermissionMode::ReadOnly,
        "batch_scan_start" => PermissionMode::WorkspaceWrite,
        "batch_scan_status" => PermissionMode::ReadOnly,
        ...
        "map_registrar_products" => PermissionMode::ReadOnly,
        ...
        "prioritize_portfolio_leads" => PermissionMode::ReadOnly,
