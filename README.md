...
[![MCP tools](https://img.shields.io/badge/MCP%20tools-64-brightgreen)](https://github.com/MadaBurns/bv-mcp/actions)
...
Download the [Blackveil DNS extension](https://github.com/MadaBurns/bv-claude-dns/releases/latest/download/bv-claude-dns.mcpb) and open it — the current 64-tool surface is available instantly. [Verify your download](https://blackveilsecurity.com/extensions/claude-dns#install).
...
- **64 MCP tools with 18 scoring categories** — SPF, DMARC, DKIM, DNSSEC, SSL/TLS, MTA-STS, NS, CAA, MX, BIMI, TLS-RPT, subdomain takeover, HTTP security headers, DANE, SVCB/HTTPS, subdomailing, brand discovery, and authoritative DNS infrastructure
...
```
  64 MCP tools · 7 prompts · 6 resources
