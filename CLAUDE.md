...
| `BV_WEB_INTERNAL_KEY`                                                | Secret           | Bearer token for `BV_WEB` internal calls — the `internalLenientAuthGate`/strict internal gates AND the M365 proxy auth (`m365ProxyAuthToken`). |
