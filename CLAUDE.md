...
| `BV_TLS_PROBE` / `BV_TLS_PROBE_KEY`                                                | Service / Secret | **Operator only.** Legacy-TLS detection for `check_ssl`; fail-soft. ⚠️ TLS-intercepted vantage — DANE pin verification kill-switched (#906) |
