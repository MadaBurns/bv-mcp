 ...
 * - 1.27.0 — the wildcard canary sees every record family (#942, dns-checks 1.39.0). Both
 ...
 *   byte-identical.
 * - 1.28.0 — `check_mx` names a loopback MX instead of mislabelling it (#944, dns-checks
 *   1.40.0). Loopback exchanges (`localhost`, `localhost.localdomain`, `*.localhost`,
