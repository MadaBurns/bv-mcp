...
## Objective
Replace the transient `npx md-to-pdf` dependency with a robust, integrated Playwright-based PDF service. This ensures faster generation, custom paged-media support (headers/footers), and reliable CI/CD verification for CSC-class reports.
...
## Phase 4: Integration with CSC Corpus (Validation)
