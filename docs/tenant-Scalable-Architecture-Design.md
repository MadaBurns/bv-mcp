# tenant-example — Scalable Architecture Design

**Status:** internal design doc, gitignored. Not for distribution.
**Date:** 2026-05-09
**Companion to:** `tenant-example-Call-Prep.md`, `Tenant-Capacity-and-Discovery-Design.md`
...
CREATE TABLE super_tenants (
  id TEXT PRIMARY KEY,                    -- e.g. 'tenant-example'
  name TEXT NOT NULL,
