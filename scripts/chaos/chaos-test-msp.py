...
MSP_PORTFOLIO = [
    ...
    "[redacted-domain]", "braintreepayments.com", "plaid.com",
...
HIGH_RISK_CLIENTS = ["[redacted-domain]", "plaid.com", "humana.com", "uhc.com", "okta.com"]
...
def test_sustained_throughput():
    ...
    tools_cycle = [
        ...
        ("check_mx",    {"domain": "[redacted-domain]",      "format": "compact"}),
