...
async def main():
    ...
    print(f"Scenario: Scaling simulation for tenant-example (2.5M Target)")
    print("-" * 60)
    ...
    base_domains = [
        ...
        "brand-auditglobal.com", "brand-auditdigitalbrand.services", "corporateservicecompany.com",
        "nytimes.com", "bbc.co.uk", "cnn.com", "reuters.com", "theguardian.com",
        "spotify.com", "adobe.com", "zoom.us", "dropbox.com", "[redacted-domain]",
        "[redacted-domain]", "shopify.com", "atlassian.com", "notion.so", "figma.com"
    ]
