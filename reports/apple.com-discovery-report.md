...
<div class="revenue-box">
  ...
  <table style="margin-top: 10px;">
    ...
    <tr>
      ...
      <td style="font-weight: bold; font-size: 16px; color: oklch(0.87 0.29 155);">$6,700 / yr</td>
    </tr>
  </table>
...
1. **Portfolio Consolidation:** Present the cryptographic evidence to the apple.com security team to initiate transfer procedures for the 2 identified domains currently managed by competing registrars, bringing them under the primary master agreement.
